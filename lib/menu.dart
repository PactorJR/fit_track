...
class MenuPage extends StatelessWidget {
  ...
  Future<void> _signOut(BuildContext context) async { // Pass context here
  ...
  void _showLogoutPrompt(BuildContext context) { // Accept context as parameter
    showDialog(
  ...
  Future<void> _proceedToSignOut(BuildContext context) async { // Accept context as parameter
    try {
      await _auth.signOut();
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView(
              children: [
                ...
                Container(
                  color: Colors.green[700], // Background for profile section
                        ...
                        children: [
                          ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => MemberBenefitsPage()), // Replace with your actual MemberBenefitsPage widget
                              );
                            },
                ...
                _buildMenuItem(
                  ...
                  label: "Settings",
                  page: SettingsPage(
                    isDarkMode: false, // You can replace this with a dynamic value if needed
